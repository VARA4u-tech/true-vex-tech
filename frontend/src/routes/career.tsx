      ...
      <main className="pt-32 pb-20">
        ...
        <section className="mx-auto max-w-7xl px-5 md:px-8">
          <div className="text-center">
            ...
            >
              Innovate with us and shape the future of technology through groundbreaking solutions
        ...
        <section className="mt-32 mx-auto max-w-7xl px-5 md:px-8">
          <div className="brutalist-card overflow-hidden bg-gradient-to-br from-card to-background relative p-10 md:p-20">
            ...
            <h2 className="font-display text-3xl font-bold md:text-5xl relative z-10">
              Our Culture & Teams
            </h2>
            <div className="mt-10 grid gap-10 lg:grid-cols-2 relative z-10">
              <p className="text-lg text-gray-400 leading-relaxed">
                At Innovate, we foster a dynamic and inclusive environment where every voice is
                heard, and innovation thrives. Our diverse teams collaborate to tackle complex
                challenges, pushing the boundaries of technology.
              </p>
              <p className="text-lg text-gray-400 leading-relaxed">
                We believe in continuous learning, mutual respect, and celebrating successes. Join a
                team where your contributions are valued and your growth is prioritized. We work
                hard, support each other, and have fun along the way.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-32 mx-auto max-w-7xl px-5 md:px-8 pb-20">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-400 uppercase tracking-widest text-xs">
            ...
            {[
              {
                ...
                desc: "Comprehensive medical, dental, and vision plans.",
              },
              ...
              { title: "Career Growth", desc: "Learning and development opportunities." },
              {
                ...
                desc: "Supportive policies for personal and family life.",
              },
              {
                title: "Competitive Salary",
                desc: "Attractive compensation packages and bonuses.",
              },
              {
              ...
              >
                <h4 className="text-lg font-bold text-[#0D7E92] group-hover:text-white transition-colors">
                  {perk.title}
                </h4>
                <p className="mt-2 text-sm text-gray-400 group-hover:text-gray-300 transition-colors leading-snug">
                  {perk.desc}
                </p>
              </motion.div>
            ))}
