    ...
    >
      <div className="relative flex w-full flex-1 items-start justify-center isolate z-0 pt-20">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-[35rem] overflow-visible w-[35rem] bg-gradient-conic from-primary via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-[35rem] w-[35rem] bg-gradient-conic from-transparent via-transparent to-primary text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-64 w-[40rem] rounded-full bg-primary opacity-40 blur-[100px]"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-32 w-[20rem] rounded-full bg-primary opacity-100 blur-3xl"
        ></motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-1 w-[70rem] bg-primary rounded-full shadow-[0_0_40px_10px_var(--color-primary)]"
        ></motion.div>
