  ...
  const jobs = [
    ...
    },
    {
      ...
      details: {
        ...
        tags: ["Vijayawada, India", "In-Office", "Senior", "Full-time"],
        jobDescription:
          "We are seeking a skilled and proactive DevOps Engineer to join our engineering team. In this role, you will be responsible for building, automating, and maintaining scalable infrastructure and deployment pipelines that support reliable and efficient software delivery. You will collaborate closely with development, QA, and operations teams to improve system performance, enhance deployment processes, and ensure high availability of applications. The ideal candidate has strong automation skills, a problem-solving mindset, and experience working in fast-paced Agile environments.",
        responsibilities: [
          ...
          "Ensure application scalability, reliability, and high availability.",
          "Collaborate with development teams to improve deployment strategies.",
          "Troubleshoot production issues and implement preventive solutions.",
          "Maintain documentation for DevOps processes and infrastructure.",
        ],
        requirements: [
          "Strong experience in DevOps tools and practices.",
